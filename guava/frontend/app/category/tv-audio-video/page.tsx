...
const tvCategory = popularCategories.find(cat => cat.slug === "tv-audio-video");
const subcategories = tvCategory?.subCategories || [];
...
export default function TVAudioVideoPage() {
  const products = categorySubcategoryProducts["tv-audio-video"] || {};
      ...
      <section className="relative bg-gradient-to-r from-[#ffdbc8] via-[#ffd9d0] to-[#ffd3c7] py-16 md:py-24 text-gray-900">
        <div className="section-wrapper text-center">
          ...
          <p className="text-lg md:text-xl opacity-90">
            Explore TVs, sound systems, projectors, and video conferencing solutions
          </p>
        </div>
      </section>
