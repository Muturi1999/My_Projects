...
const accessoriesCategory = popularCategories.find(cat => cat.slug === "computer-accessories");
const subcategories = accessoriesCategory?.subCategories || [];
...
export default function ComputerAccessoriesPage() {
  const products = categorySubcategoryProducts["computer-accessories"] || {};
      ...
      <section className="relative bg-gradient-to-r from-[#ffdbc8] via-[#ffd9d0] to-[#ffd3c7] py-16 md:py-24 text-gray-900">
        <div className="section-wrapper text-center">
          ...
          <p className="text-lg md:text-xl opacity-90">
            Essential accessories for your computer setup
          </p>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-4">
        <div className="section-wrapper">
          <div className="flex items-center gap-4 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-medium">Computer Accessories</span>
          </div>
        </div>
      </section>
