...
const cctvCategory = popularCategories.find(cat => cat.slug === "cctv-security");
const subcategories = cctvCategory?.subCategories || [];
...
export default function CCTVSecurityPage() {
  const products = categorySubcategoryProducts["cctv-security"] || {};
      ...
      <section className="relative bg-gradient-to-r from-[#ffdbc8] via-[#ffd9d0] to-[#ffd3c7] py-16 md:py-24 text-gray-900">
        <div className="section-wrapper text-center">
          ...
          <p className="text-lg md:text-xl opacity-90">
            Complete security solutions for your home and business
          </p>
        </div>
      </section>
