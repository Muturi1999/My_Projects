    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Create and manage custom content blocks that can be placed on any page.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <p className="text-sm text-gray-500">Custom sections management interface coming soon...</p>
      </div>
    </div>
  );
}
